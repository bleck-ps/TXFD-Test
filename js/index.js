...
function starter() {
    setTimeout(function(){
        ...
        navmaster.style.background = "#f9c19b";
        setTimeout(function(){
...
function travelerup(){
    if(travact == 0) {
        if (travelerstat == 2){
            ...
            setTimeout(function(){travact=0;},1000);
            setTimeout(function(){
                travelerimg.src = 'img/RCS/traveler-af.png'
    ...
    if(travact == 0) {
        if (travelerstat == 1){
            ...
            setTimeout(function(){travact=0;},1000);
            setTimeout(function(){
                travelerimg.src = 'img/RCS/traveler.png'
                travelerimg.style.background = 'none';
            },500);
        }
    }
    ...
    setTimeout(function(){
        ...
        document.getElementById('videoclose').addEventListener('click',function(){
            ...
            setTimeout(function(){
                campanabox.style.display = "none";
                travelerstart();
                document.getElementById('videocampana').style.display = "none";
                document.getElementById('videocampana').pause();
                videocampana.src = "";
                document.getElementById('videocampana').load();
            },1000);
        })
    })
}
...
function tnsection1(){
    ...
    buttonend();
    if (language == 2){
        menupage.src = 'img/menu/ing/TXCHH _Breakfast.jpg';
    } else if (language == 1){
        menupage.src = 'img/menu/esp/TXCHH_Desayunos.jpg';
    }
}
...
function tnsection2(){
    ...
    if (language == 2){
        menupage.src = 'img/menu/ing/TXCHH_Meals.jpg';
    } else if (language == 1){
        menupage.src = 'img/menu/esp/TXCHH_Comidas.jpg';
    }
}
...
function tnsection3(){
    ...
    buttonend();
    if (language == 2){
        menupage.src = 'img/menu/ing/TXCHH_Beverages.jpg';
    } else if (language == 1){
        menupage.src = 'img/menu/esp/TXCHH_Bebidas.jpg';
    }
}
...
function tnsection4(){
    ...
    buttonend();
    if (language == 2){
        menupage.src = 'img/menu/ing/TXCHH_B&C.jpg';
    } else if (language == 1){
        menupage.src = 'img/menu/esp/TXCHH_C&C.jpg';
    }
}
...
function tnsection5(){
    ...
    buttonend();
    if (language == 2){
        menupage.src = 'img/menu/ing/TXCHH_S&W.jpg';
    } else if (language == 1){
        menupage.src = 'img/menu/esp/TXCHH_D&V.jpg';
    }
}
...
function tnsection6(){
    ...
    buttonend();
    if (language == 2){
        menupage.src = 'img/menu/ing/TXCHH_Desserts.jpg';
        menupage.style.marginBottom = "500px";
    } else if (language == 1){
        menupage.src = 'img/menu/esp/TXCHH_Postres.jpg';
        menupage.style.marginBottom = "500px";
    }
}
...
function reset(){
    ...
    menupage.style.marginBottom = "0px";
}
...
function setenglish() {
    ...
    menunavimg.src = 'img/RCS/menunaving.png';
    btnsection1.src = 'img/nav/ing/breakfast.png';
    btnsection2.src = 'img/nav/ing/foods.png';
    ...
    buttonmenu.src = 'img/bebidas/bebidas-ing.png'
...
function setespanol() {
    ...
    menunavimg.src = 'img/RCS/menunavesp.png';
    btnsection1.src = 'img/nav/esp/desayunos.png';
    btnsection2.src = 'img/nav/esp/comidas.png';
    ...
    buttonmenu.src = 'img/bebidas/bebidas-esp.png'
